...
export const LogIn = () => {
    ...
    const [logInDetails, setLogInDetails] = useState<logIn>({ "emailAddress": "", "password": "" });
            ...
            <div className="container">
                ...
                <div className={`sign-in-container ${signIn ? 'active' : ''}`}>
                    <form className="form" onSubmit={onLogIn}>
                        <h1>Sign in</h1>
                        <input name="emailAddress" type="email" placeholder="Email" value={logInDetails.emailAddress} className='login-input' onChange={handleLogInChange} />
